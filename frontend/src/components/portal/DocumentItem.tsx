...
import type { DocumentEntry, DocumentStatus } from '../../types';
import { StatusBadge } from '../shared/StatusBadge';
import { DocumentStatusEditor } from '../admin/DocumentStatusEditor';
...
export function DocumentItem({
  ...
  return (
    <div className="relative">
      <div className={clsx(
        ...
        <div className="flex items-center space-x-3 ml-4 flex-shrink-0">
          ...
          <div className="flex items-center space-x-1">
            ...
            {!isEditing && clientMode && needsUpload && (
              <button
                onClick={() => setShowUpload(!showUpload)}
                className={clsx(
                  'p-1.5 rounded inline-flex items-center gap-1.5',
                  showUpload 
      ...
      {/* Upload panel - full width below the row for visibility */}
      {showUpload && (
        <div className="mt-3 p-4 rounded-lg border-2 border-dashed border-primary-200 bg-primary-50/30">
          <FileUpload
            projectId={projectId}
